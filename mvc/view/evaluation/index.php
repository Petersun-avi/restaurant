<div class="box">
    <div class="box-content">
        <div class="box-header">
            <a class="btn" href="<?php echo $this->createUrl('create'); ?>"><i class="fa fa-plus"></i>添加评价</a>
        ...
        <div class="box-table">
            <table class="list">
                ...
                <tr>
                    ...
                    <th><?php echo $model->getAttributeLabel('eval_dish'); ?></th>
                ...
                <?php foreach ($arclist as $v) {
                        if($v->eval_rest == $_SESSION['rest'] && $v->eval_dish == $_SESSION['dish']){
                    ?>
                    <tr>
                        <td class="check check-item"><input class="input-check" type="checkbox"
                                                            value="<?php echo CHtml::encode($v->id); ?>"></td>
                        <td style='text-align: center;'><?php echo $v->eval_rest; ?></td>
                        <td style='text-align: center;'><?php echo $v->eval_dish; ?></td>
